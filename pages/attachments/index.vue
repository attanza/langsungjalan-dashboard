<template>
  <div>
    ...
    <dform :show="showForm" :is-edit="isEdit" :data-to-edit="dataToEdit" @onClose="formClose" @onAdd="addData" @onEdit="editData"/>
  ...
  methods: {
    async pupulateTable() {
      try {
        ...
        const endPoint = `${ATTACHMENTS_URL}?${this.getQueryParams()}`
